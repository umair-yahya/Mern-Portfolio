        ...
        <div className="container lg:pt-5">
            <div className="text-center">
                ...
                <p className='lg:max-w-[600px] lg:mx-auto text-headingColor font-[500] text-[16px] leading-7'>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Error, sed quo voluptates porro, deserunt amet veniam minima aliquam odio a explicabo,
                     molestias quisquam id itaque maxime eaque facilis reiciendis libero?
                </p>
            </div>
            ...
            <div className='flex flex-col justify-center sm:py-12'>
                <div className='w-full py-3 px-2 sm:max-w-xl sm:mx-auto sm:px-0'>
                    <div className='relative text-gray-700 antialiased text-sm font-semibold'>
                        ...
                        <div className='hidden absolute w-1 sm:block bg-indigo-300 h-full left-1/2 tranform 
                    -translate-x-1/2'></div>
                                 ...
                                 <div className='flex justify-start w-full mx-auto items-center'>
                                    <div className='w-full sm:w-1/2 sm:pr-8'>
                                        ...
                                        ease-in duration-150'>
                                            ...
                                            group-hover:font-[500]'>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                             Modi rem adipisci quod quas harum repellat.</p>
                                        </div>
                                    </div>
                                </div>

                                <div className='rounded-full bg-primaryColor border-white border-4 w-10
