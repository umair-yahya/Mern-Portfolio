      ...
      <div className='container'>
        <div className='sm:flex items-center justify-between md:gap-8'>
          <div className='w-full sm:w-1/2'>
            ...
            md:text-[2rem]'>Do you want to make beautiful products?</h2>
            <a href="#contact">
          ...
          <div className="w-full sm:w-1/2">
            <p className='text-gray-300 leading-7 mt-4 sm:mt-0'>
             ...
             Quisquam tempora quaerat quis quam temporibus officia!
            </p>
            ...
            <div className="flex items-center gap-4 flex-wrap md:gap-8 mt-10">
              ...
              text-center'>
                ...
                </a><i class='ri-github-line'></i>
                </span>
                <span className='w-[35px] h-[35px] bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer
              text-center'>
                <a href="#github" className='text-gray-300 font-[500] text-[18px]'>
                </a><i class='ri-youtube-line'></i>
                </span>
                <span className='w-[35px] h-[35px] bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer
              text-center'>
                <a href="#github" className='text-gray-300 font-[500] text-[18px]'>
